...
public class MealsUtil {
    public final static AtomicInteger ID_GENERATOR = new AtomicInteger(0);
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
    ...
    public static Meal createMeal(LocalDateTime localDateTime, String description, int calories){
        return new Meal(ID_GENERATOR.getAndIncrement(), localDateTime, description, calories);
    }
